...
export PRETRAIN_MODEL_PATH="./iqa-r1-ava-evalmuse-koniq-grpo-score-7B-rl-stage1/"  # Path to pretrained model
export SAVE_PATH="./checkpoints_rl_cot/"                   # Path to save checkpoints

# Model configuration
export MODEL_NAME="iqa-r1-ava-evalmuse-koniq-grpo-score-7B-rl-stage2"              # Name for this training run
...
ray job submit --address="http://127.0.0.1:$RAY_DASHBOARD_PORT" \
   ...
   -- python -m openrlhf.cli.train_ppo_ray_improved \
   --ref_num_nodes 1 \
   ...
   --use_high_entropy \
   --high_entropy_rho 0.2 \
   --enable_accuracy_filter  \
   --min_gaussian_std 0.001 \
