...
if __name__ == "__main__":
    ...
    parser.add_argument("--min_gaussian_std", type=float, default=0.001, help="Lower bound for accuracy")

    # Experimental parameters added
    ...
    parser.add_argument("--freezing_entropy_steps", type=int, default=-1)
