...
from openrlhf.trainer import PPOTrainer,PPOTrainer_improved
from openrlhf.trainer.ppo_utils import Experience, RemoteExperienceMaker
from openrlhf.trainer.ppo_utils import Experience_improved, RemoteExperienceMaker_improved
...
class ActorPPOTrainer_improved(PPOTrainer_improved):
    def __init__(
        self,
        *args,
        ...
        **kwargs,
        ...
        self.experience_maker = RemoteExperienceMaker_improved(
            self.actor,
            self.critic,
            self.reward_model,
            self.initial_model,
    ...
    def training_step(self, experience: Experience_improved, global_steps) -> Dict[str, float]:
        ...
        if global_steps > self.freezing_entropy_steps:
           return self.training_step_actor(experience,use_entropy=True)
        else:
           return self.training_step_actor(experience,use_entropy=False)
...
class ActorModelRayActor_improved(BasePPORole):
    ...
    def fit(
        ...
        # configure Trainer
        trainer = ActorPPOTrainer_improved(
            strategy,
            self.actor,
            critic_model,
            reward_model,
